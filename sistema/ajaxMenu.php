	...
	case 'agregarMenu':	
		...
		*/
			...
			//	$idUsuario = $_SESSION['id'];
				...
				$sql = "insert into menu (nombre,pagina,padre) values ('$nombre','$pagina',$padre)";
           ...
           // $stmt = mysqli_prepare($conn, "CALL agregarMenu(?, ?, ?, ?)");
                          ...
                          //     echo "stmat=". $stmt . "<br>";
                                 ...
                                 /*
                                    Esta línea prepara la consulta para llamar al procedimiento almacenado agregarMenu(). 
                                    La función mysqli_prepare() toma dos parámetros:
...
BEGIN
  ...
  VALUES (idMenu, idUsuari  $result = mysqli_query($conn,$sql);o);
