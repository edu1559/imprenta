...
// pendiente de pedidos ya concretados, venta=1 / compra=2).
// ---------------------------------------------------------------------
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 bg-white p-3 shadow-sm rounded">
        <div>
            <h3 class="text-success mb-0 fw-bold">
                <i class="bi bi-graph-up-arrow me-2"></i> Indicadores Financieros
            </h3>
...
function cargarIndicadores(overrides) {
    ...
    var qs = $.param(params);
    $('#contenido').load('finanzas/indicadores.php?' + qs);
}
