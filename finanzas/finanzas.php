...
while ($row = mysqli_fetch_assoc($resCierre)) {
    ...
    // --- CAMBIO CLAVE AQUÍ: Restar si idTipoPedido es 2 ---
    $sqlSum = "SELECT 
                COUNT(p.id) as cant, 
...
<div class="container-fluid p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold"><i class="bi bi-bank text-success me-2"></i>Cierre de Finanzas</h2>
        <button id="btnCerrarTodos" class="btn btn-success btn-lg shadow">
            <i class="bi bi-check-all"></i> Realizar Cierre General del Día
        </button>
    </div>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group">
                                            ...
                                            <button class="btn btn-outline-success btn-sm btnCerrarIndividual" data-id="<?php echo $id; ?>">
            ...
            <div class="card mt-4 shadow-sm border-0">
                <div class="card-header bg-secondary text-white py-2 small">Historial de Cierres Consolidados</div>
...
$('.btnCerrarIndividual').click(function() {
    ...
    if(confirm('¿Confirmas el cierre individual de este medio con un saldo de $' + v_montoReal + '?')) {
        $.post('finanzas/ajaxCierre.php', {
            opcion: 'cierre',
            idMedio: v_idMedio,
...
$('#btnCerrarTodos').click(function() {
    if (!confirm('¿Estás seguro de realizar el cierre general? Se archivarán los saldos actuales y se reiniciará el contador de movimientos.')) return;
